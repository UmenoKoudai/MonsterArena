...
public class ThrowingScript : MonoBehaviour
{
    ...
    private Vector3 CalculateVelocity(Vector3 pointA, Vector3 pointB, float angle)
    {
        ...
        Debug.Log($"Pos1{new Vector2(pointA.x, pointA.z)}");
        Debug.Log($"Pos2{new Vector2(pointB.x, pointB.z)}");
        Debug.Log($"X{x}");
        ...
        {
            Debug.Log($"Return{new Vector3(pointB.x - pointA.x, x * Mathf.Tan(rad), pointB.z - pointA.z).normalized * speed}");
